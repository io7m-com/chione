...
public final class ChPasswordAlgorithmPBKDF2HmacSHA256
  implements ChPasswordAlgorithmType
{
  private final int iterationCount;
  private final int keyLength;

  private ChPasswordAlgorithmPBKDF2HmacSHA256(
  ...
  public static ChPasswordAlgorithmType create(
    final int iterationCount,
    final int keyLength)
  {
    return new ChPasswordAlgorithmPBKDF2HmacSHA256(iterationCount, keyLength);
  }
    ...
    final Object o)
  {
    ...
    final ChPasswordAlgorithmPBKDF2HmacSHA256 that = (ChPasswordAlgorithmPBKDF2HmacSHA256) o;
  ...
  @Override
  public ChPassword createHashed(
