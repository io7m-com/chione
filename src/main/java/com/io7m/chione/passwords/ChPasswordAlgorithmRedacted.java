...
public final class ChPasswordAlgorithmRedacted
  implements ChPasswordAlgorithmType
{
  private static final ChPasswordAlgorithmRedacted INSTANCE =
    new ChPasswordAlgorithmRedacted();

  private ChPasswordAlgorithmRedacted()
  {
