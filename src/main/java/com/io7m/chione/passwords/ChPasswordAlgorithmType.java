...
public sealed interface ChPasswordAlgorithmType
  permits ChPasswordAlgorithmPBKDF2HmacSHA256, ChPasswordAlgorithmRedacted
{
  /**
  ...
  default ChPassword createHashed(
